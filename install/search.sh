#!/usr/bin/env bash
# install/search.sh — search, navigation and parsing tools. All via mise (aqua).
#   AI coding agents: rg fd jq yq dasel gron ast-grep typos
#   human dev:        fzf bat eza zoxide hyperfine
